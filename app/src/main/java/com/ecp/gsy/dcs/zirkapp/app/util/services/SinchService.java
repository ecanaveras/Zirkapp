...
/**
 * Created by ecanaveras on 09/09/2015.
 */

public class SinchService extends Service {

    private static final String APP_KEY = "e4287600-6187-4659-90c8-da1bef616489";
    private static final String APP_SECRET = "GGOGQzBGX0qHMyl4UrIrEQ==";
    ...
    public class SinchServiceInterface extends Binder {
        ...
        public void startClient(String userName, String regId) {
            start(userName, regId);
        }
    ...
    private void start(String userName, String regId) {
        if (mSinchClient == null) {
            ...
            mSinchClient.start();
            if (regId != null)
                mSinchClient.registerPushNotificationData(regId.getBytes());
        }
    }
